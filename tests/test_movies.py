...
class TestMovies(BaseTestCase):
    ...
    def test_get_all_movies(self, test_client, movie, auth_header):
        ...
        self.assertEqual(response.json['movies'][0], {
                         'id': 1, 'name': 'sim', 'date_of_release': '2019-08-05 00:00:00',
                         'length': '02:30:00', 'summary': None,
                         'category': 'horror', 'rating': 1})
    ...
    def test_update_movie_by_id_succeeds(self, test_client, movie, auth_header):
        ...
        self.assertEqual(response.json['movie'][0], {'id': 1, 'name': 'Lord of thmke rings',
                                                     'date_of_release': '2019-11-09 00:00:00',
                                                     'length': '02:30:00',
                                                     'summary': 'Simoejnjlkanfwdybusnrj,',
                                                     'category': 'somejr', 'rating': 1})
