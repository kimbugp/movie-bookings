...
cinemahall = [
    {"name": "Cinema1", "description": "SOme data"},
    {"name": "Cimena2", "description": "something esle"},
    {"name": "Cinema 3", "description": "slef"},
]
...
seat = [
    ...
    {"number": 3, "cinema_hall": 1, "name": "c"},
    {"number": 2, "cinema_hall": 1, "name": "d"},
    {"number": 4, "cinema_hall": 1, "name": "e"},
    {"number": 1, "cinema_hall": 2, "name": "f"},
...
ticket = [
    {"payment_method": "mm", "seat_id": 1, "user_id": 1, "showtime_id": 1},
    {"payment_method": "mm", "seat_id": 2, "user_id": 1, "showtime_id": 1},
    {"payment_method": "mm", "seat_id": 3, "user_id": 1, "showtime_id": 1},
    {"payment_method": "mm", "seat_id": 4, "user_id": 1, "showtime_id": 2},
    {"payment_method": "mm", "seat_id": 5, "user_id": 1, "showtime_id": 4},
    {"payment_method": "mm", "seat_id": 6, "user_id": 1, "showtime_id": 4},
]
